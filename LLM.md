...
- `create_feedback_issue` - Create GitHub issue with auto-attached screenshots (via modern-screenshot DOM capture)
...
- modern-screenshot for client-side DOM screenshot capture (supports CSS Color Level 4)

**GitHub Issue Integration:**
- `POST /api/feedback/screenshots` - Upload screenshot attachments to GitHub issues
- Screenshots captured client-side via modern-screenshot, uploaded as base64
